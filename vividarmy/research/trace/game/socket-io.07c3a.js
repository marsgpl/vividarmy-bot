...
/***/ (function(module, exports, __webpack_require__) {
	...
	Manager.prototype.open = Manager.prototype.connect = function (fn, opts) {
	  ...
	  if (~this.readyState.indexOf('open')) return this;
		...
		{
				this.initTimeout =60*1000;// this.opts['timeout'];
			 
		}
		
		/*if( window['onHideTimeSam']) 
		{
			console.warn('onHideTimeSam'+this.initTimeout);
			this.opts['timeout'] =60*1000;
			this._timeout=60*1000;
		}
		else
		{
			this.opts['timeout'] = this.initTimeout;
			this._timeout=this.initTimeout;
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
 //  window['WebSocket2'] = require('libs/weapp-adapter/WebSocket');
 //  BrowserWebSocket=NodeWebSocket=window['WebSocket2']
	// console.warn('websocket ---- '+!!window['WebSocket2']+','+ !!BrowserWebSocket+','+!!NodeWebSocket)
